                  ...
                  children: [
                    ...
                    cityWeather != null
                        ? Container(
                            ...
                            child: FittedBox(
                              child: AutoSizeText(
                                '${Temperature(cityWeather!.temperature).as(tempUnit).round()}' +
                                    Temperature.getTemperSympol(tempUnit),
                                maxLines: 1,
                                style: TextStyle(
                      ...
                      cityWeather != null
                          ? Container(
                              ...
                              child: FittedBox(
                                ...
                                child: AutoSizeText(
                                  '${Temperature(cityWeather!.maxTemperature).as(tempUnit).round()}' +
                ...
                Row(
                  children: [
                    ValueTile(
                      ...
                      cityWeather != null
                          ? Text(
                              '${Temperature(cityWeather!.minTemperature).as(tempUnit).round()}' +
                                  Temperature.getTemperSympol(tempUnit),
                              overflow: TextOverflow.clip,
                              style: TextStyle(
                                  color: Colors.white,
